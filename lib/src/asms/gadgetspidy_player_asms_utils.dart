...
import 'package:gadgetspidy_player/src/dash/gadgetspidy_player_dash_utils.dart';
import 'package:gadgetspidy_player/src/hls/gadgetspidy_player_hls_utils.dart';

import 'gadgetspidy_player_asms_data_holder.dart';

///Base helper class for ASMS parsing.
class GadgetspidyPlayerAsmsUtils {
  ...
  static Future<GadgetspidyPlayerAsmsDataHolder> parse(
    ...
    return isDataSourceDash(masterPlaylistUrl)
        ? GadgetspidyPlayerDashUtils.parse(data, masterPlaylistUrl)
        : GadgetspidyPlayerHlsUtils.parse(data, masterPlaylistUrl);
  }
  ...
  static Future<String?> getDataFromUrl(
    ...
    try {
      ...
      GadgetspidyPlayerUtils.log("GetDataFromUrl failed: $exception");
      return null;
    }
  }
}
