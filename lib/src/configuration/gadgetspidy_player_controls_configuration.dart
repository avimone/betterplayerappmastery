...
class GadgetspidyPlayerPipConfiguration {
  ...
  const GadgetspidyPlayerPipConfiguration({
    this.enabled = true,
...
///UI configuration of Gadgetspidy Player. Allows to change colors/icons/behavior
///of controls. Used in GadgetspidyPlayerConfiguration. Configuration applies only
///for player displayed in app, not in notification or PiP mode.
class GadgetspidyPlayerControlsConfiguration {
  /// Picture in Picture configuration
  final GadgetspidyPlayerPipConfiguration pipConfiguration;
  ...
  final List<GadgetspidyPlayerOverflowMenuItem> overflowMenuCustomItems;
  ...
  const GadgetspidyPlayerControlsConfiguration({
    ...
    this.pipConfiguration =
        const GadgetspidyPlayerPipConfiguration(), // Add with default value
    this.fullScreenButtonExit =
        false, // 🚀 NEW: Default to normal fullscreen behavior
  });

  factory GadgetspidyPlayerControlsConfiguration.white() {
    return const GadgetspidyPlayerControlsConfiguration(
  ...
  factory GadgetspidyPlayerControlsConfiguration.cupertino() {
    return const GadgetspidyPlayerControlsConfiguration(
  ...
  ///Setup GadgetspidyPlayerControlsConfiguration based on Theme options.
  factory GadgetspidyPlayerControlsConfiguration.theme(ThemeData theme) {
    return GadgetspidyPlayerControlsConfiguration(
