...
///Configuration of Gadgetspidy Player. Allows to setup general behavior of player.
///Master configuration which contains children that configure specific part
///of player.
class GadgetspidyPlayerConfiguration {
  ...
  final GadgetspidyPlayerRoutePageBuilder? routePageBuilder;

  /// Defines a event listener where video player events will be send
  final Function(GadgetspidyPlayerEvent)? eventListener;

  ///Defines subtitles configuration
  final GadgetspidyPlayerSubtitlesConfiguration subtitlesConfiguration;
  ...
  ///will be used.
  final List<GadgetspidyPlayerTranslations>? translations;
  ...
  ///[GadgetspidyPlayerController] on [GadgetspidyPlayer] dispose. When it's true and
  ///[GadgetspidyPlayerController] instance has been attached to [GadgetspidyPlayer] widget
  ///and dispose has been called on [GadgetspidyPlayer] instance, then
  ///[GadgetspidyPlayerController] will be disposed.
  ...
  const GadgetspidyPlayerConfiguration({
    ...
    this.subtitlesConfiguration =
        const GadgetspidyPlayerSubtitlesConfiguration(),
    this.controlsConfiguration = const GadgetspidyPlayerControlsConfiguration(),
  ...
  GadgetspidyPlayerConfiguration copyWith({
    double? aspectRatio,
    bool? autoPlay,
    Duration? startAt,
    bool? looping,
    ...
    GadgetspidyPlayerRoutePageBuilder? routePageBuilder,
    Function(GadgetspidyPlayerEvent)? eventListener,
    GadgetspidyPlayerSubtitlesConfiguration? subtitlesConfiguration,
    GadgetspidyPlayerControlsConfiguration? controlsConfiguration,
    BoxFit? fit,
    double? rotation,
    Function(double visibilityFraction)? playerVisibilityChangedBehavior,
    List<GadgetspidyPlayerTranslations>? translations,
    ...
    return GadgetspidyPlayerConfiguration(
