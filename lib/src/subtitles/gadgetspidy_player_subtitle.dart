...
class GadgetspidyPlayerSubtitle {
  ...
  factory GadgetspidyPlayerSubtitle(String value, bool isWebVTT) {
    try {
      ...
      return GadgetspidyPlayerSubtitle._();
    } catch (exception) {
      GadgetspidyPlayerUtils.log("Failed to parse subtitle line: $value");
      return GadgetspidyPlayerSubtitle._();
    }
  }

  static GadgetspidyPlayerSubtitle _handle2LinesSubtitles(
      List<String> scanner) {
    try {
      ...
      GadgetspidyPlayerUtils.log("Failed to parse subtitle line: $scanner");
      return GadgetspidyPlayerSubtitle._();
    }
  }

  static GadgetspidyPlayerSubtitle _handle3LinesAndMoreSubtitles(
  ...
  static Duration _stringToDuration(String value) {
    try {
      ...
      GadgetspidyPlayerUtils.log("Failed to process value: $value");
      return const Duration();
    }
  }
  ...
  @override
  String toString() {
    return 'GadgetspidyPlayerSubtitle{index: $index, start: $start, end: $end, texts: $texts}';
  }
}
