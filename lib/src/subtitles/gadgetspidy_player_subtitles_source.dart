...
import 'gadgetspidy_player_subtitles_source_type.dart';

///Representation of subtitles source. Used to define subtitles in Gadgetspidy
/// Player.
class GadgetspidyPlayerSubtitlesSource {
  ///Source type
  final GadgetspidyPlayerSubtitlesSourceType? type;
  ...
  // [GadgetspidyPlayerSubtitlesSourceType.memory] source type.
  ...
  static List<GadgetspidyPlayerSubtitlesSource> single({
    GadgetspidyPlayerSubtitlesSourceType? type,
