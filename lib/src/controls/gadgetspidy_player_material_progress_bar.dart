...
class GadgetspidyPlayerMaterialVideoProgressBar extends StatefulWidget {
  GadgetspidyPlayerMaterialVideoProgressBar(
    this.controller,
...
class _VideoProgressBarState
    extends State<GadgetspidyPlayerMaterialVideoProgressBar> {
