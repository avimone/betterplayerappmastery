...
///DASH helper class
class GadgetspidyPlayerDashUtils {
  static Future<GadgetspidyPlayerAsmsDataHolder> parse(
    ...
    try {
      ...
      GadgetspidyPlayerUtils.log("Exception on dash parse: $exception");
    }
    return GadgetspidyPlayerAsmsDataHolder(
        tracks: tracks, audios: audios, subtitles: subtitles);
  }

  static List<GadgetspidyPlayerAsmsTrack> parseVideo(XmlElement node) {
    ...
    representations.forEach((representation) {
      ...
      tracks.add(GadgetspidyPlayerAsmsTrack(
  ...
  static GadgetspidyPlayerAsmsAudioTrack parseAudio(
      XmlElement node, int index) {
    ...
    return GadgetspidyPlayerAsmsAudioTrack(
        id: index,
  ...
  static GadgetspidyPlayerAsmsSubtitle parseSubtitle(
