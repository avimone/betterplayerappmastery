...
#import "GadgetspidyPlayerTimeUtils.h"
#import "GadgetspidyPlayerView.h"
#import "GadgetspidyPlayerEzDrmAssetsLoaderDelegate.h"

NS_ASSUME_NONNULL_BEGIN

@class CacheManager;

@interface GadgetspidyPlayer : NSObject <FlutterPlatformView, FlutterStreamHandler, AVPictureInPictureControllerDelegate>
@property(readonly, nonatomic) AVPlayer* player;
@property(readonly, nonatomic) GadgetspidyPlayerEzDrmAssetsLoaderDelegate* loaderDelegate;
