...
class ImageWorker(
    ...
    override fun doWork(): Result {
        return try {
            val imageUrl = inputData.getString(GadgetspidyPlayerPlugin.URL_PARAMETER)
            ...
            val data =
                Data.Builder().putString(GadgetspidyPlayerPlugin.FILE_PATH_PARAMETER, filePath).build()
            Result.success(data)
        } catch (e: Exception) {
            e.printStackTrace()
            Result.failure()
