...
internal class CacheDataSourceFactory(
    ...
    override fun createDataSource(): CacheDataSource {
        val gadgetspidyPlayerCache = GadgetspidyPlayerCache.createCache(context, maxCacheSize)
            ?: throw IllegalStateException("Cache can't be null.")

        return CacheDataSource(
            gadgetspidyPlayerCache,
            defaultDatasourceFactory?.createDataSource(),
            FileDataSource(),
            CacheDataSink(gadgetspidyPlayerCache, maxFileSize),
